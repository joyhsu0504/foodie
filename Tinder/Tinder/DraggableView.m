...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        information = [[UILabel alloc]initWithFrame:CGRectMake(0, 50, self.frame.size.width, 50)];
        information.text = @"test";
        [information setTextAlignment:NSTextAlignmentCenter];
        information.textColor = [UIColor blackColor];
        
        text = [[UITextView alloc] initWithFrame:CGRectMake(0, 120, self.frame.size.width, 300)];
        text.text = @"test2";
